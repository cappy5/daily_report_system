...
public interface JpaConst {
    ...
    String EMP_COL_NAME = "name";               //社員名
    String EMP_COL_PASS = "password";           //パスワード
    String EMP_COL_ADMIN_FLAG = "admin_flag";   //管理者権限
    String EMP_COL_CREATED_AT = "created_at";   //作成日時
    ...
    int EMP_DEL_FALSE = 0;   //現役

    //日報テーブル
    String TABLE_REP = "reports"; //テーブル名
    //日報テーブルカラム
    String REP_COL_ID = "id";                   //id
    String REP_COL_EMP = "employee_id";         //日報を作成した従業員ID
    String REP_COL_REP_DATE = "report_date";    //日報日付
    String REP_COL_TITLE =  "title";            //日報タイトル
    String REP_COL_CONTENT =  "content";        //日報内容
    String REP_COL_CREATED_AT =  "created_at";  //作成日時
