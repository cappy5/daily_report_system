...
@NamedQueries({
        ...
        @NamedQuery(name = JpaConst.Q_EMP_COUNT_REGISTERED_BY_CODE, query = JpaConst.Q_EMP_GET_BY_CODE_AND_PASS_DEF),
...
public class Employee {
    ...
    @Column(name = JpaConst.EMP_COL_PASS, nullable = false, length = 64)
