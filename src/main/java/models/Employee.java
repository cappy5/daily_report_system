...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_EMP_GET_EMP_BY_REP_ID,
            query = JpaConst.Q_EMP_GET_EMP_BY_REP_ID_DEF),
    @NamedQuery(
            name = JpaConst.Q_EMP_GET_EMP_BY_LOGIN_ID,
            query = JpaConst.Q_EMP_GET_EMP_BY_LOGIN_ID_DEF),
    @NamedQuery(
            name = JpaConst.Q_EMP_COUNT_FOLLOWEE_BY_LOGIN_ID,
            query = JpaConst.Q_EMP_COUNT_FOLLOWEE_BY_LOGIN_ID_DEF),
    @NamedQuery(
            name = JpaConst.Q_EMP_GET_EMP_BY_POS_CODE,
            query = JpaConst.Q_EMP_GET_EMP_BY_POS_CODE_DEF)
})
...
public class Employee {
     ...
     */
    @ManyToOne
    @JoinColumn(name = JpaConst.EMP_COL_POSITION_CODE, nullable = false)
